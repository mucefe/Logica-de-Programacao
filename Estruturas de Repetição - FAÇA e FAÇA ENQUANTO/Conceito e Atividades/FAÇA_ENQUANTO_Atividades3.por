// Estruturas de Repetição - ENQUANTO E FAÇA ENQUANTO - Atividades 3
...
• Caso a nota seja menor do que 7, o aluno será autorizado a realizar uma prova
de recuperação.
...
programa
{		
	...
	funcao inicio()
	{
		...
		enquanto ((nota<7) ou (nota>10)){
			...
			se ((nota>=0) ou (nota<7)){
				qtdProvasRec+=1
				escreva("\nSua nota foi " + nota + ", e você tem direito a recuperação!")
				escreva("\nDigite a nota tirada na recuperação: ")
				leia(nota)
			} senao {
				escreva("\nSua nota foi inválida. Digite novamente: ")
				leia(nota)
			}
		}
		limpa()
		...
		se (qtdProvasRec==0){
			...
			escreva("\nVocê precisou de apenas uma prova de recuperação.")
		} senao {
