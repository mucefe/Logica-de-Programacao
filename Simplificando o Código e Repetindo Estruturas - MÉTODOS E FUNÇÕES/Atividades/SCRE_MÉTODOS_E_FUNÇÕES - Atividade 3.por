// Simplificando o Código e Repetindo Estrututas - Métodos e Funções - Atividade 3
...
programa
{
	...
	funcao inicio()
	{
		...
		escreva("Este programa tem a finalidade de calcular a média das notas do aluno.\n")

		para (inteiro i=0;i<3;i++){
			notas[i]=insereNota(i)
		}

		escreva("\nQual o tipo de média que você gostaria de calcular? Digite 1 para o cálculo aritmético; ou 2 para o cálculo ponderado.")
		leia(tipoMedia)
